...
<li class="col-xs-1 padding-0">
	...
	<span class='am-badge am-round pull-left'><?php echo $bdnum;?></span><span class="text-muted pull-right"><?php echo $topnum;?> ℃</span><em class='text-red'></em>&nbsp;<?php echo $title;?>
</a></li> 
<?php }$i ++;}}?>
				</ul>
          </div>
...
<div class="stui-pannel stui-pannel-bg clearfix">
	...
	<div class="stui-pannel_hd">
	<div class="stui-pannel__head active bottom-line clearfix">
	<h3 class="title">今日动漫热搜排行榜</h3></div>
	</div>
	</div>
	    <ul class="wprm">
			<b><?php
