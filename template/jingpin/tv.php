...
if ($i<1){echo 'active';}
echo '"><a class="stui-banner__pic" href="seacher-'.$listt['data'][$i]['link'].'.html" alt="'.$listt['data'][$i]['link'].'" style="background: url('.$listt['data'][$i]['cover'].') rgba(98,71,136,0) no-repeat; background-position: center center; background-size: cover; display: block; width: 100%; height: 100%;" title="'.$listt['data'][$i]['link'].'"><div class="am-slider-desc"><div class="am-slider-content"><h3 class="am-slider-title">'.$listt['data'][$i]['link'].' - '.$listt['data'][$i]['desc'].'</h3><p></p></div></div></a></div>';}?>
</div>
</div>
<style type="text/css">
