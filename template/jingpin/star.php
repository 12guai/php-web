...
if (!empty($flid1)){?>
			...
			<div class="stui-pannel_bd">
				...
				<ul class="stui-page text-center cleafix"><?php if (!empty($mingxing)){?><?php include('system/mxfenye.php');?><?php }else{?><p style="text-align: center;"><img class="sosoimg" src="template/jingpin/img/blank.png" alt="暂无内容"/></p><?php }?>
				</ul>
			</div>
 <?php } else{echo "";}?>
 </div>
 ...
 <div class="stui-pannel stui-pannel-bg clearfix">
	...
	<div class="stui-pannel_hd">
	<div class="stui-pannel__head active bottom-line clearfix">
	<h3 class="title">今日女明星排行榜</h3></div>
	</div>
	</div>
			<ul class="wprm">
				<b><?php
					...
					$xh = 0;
					while ($xh < 50) {?>
					<li><a href="mxstar_<?php echo $matches[3][$xh];?>_dy_1.html" onclick="document.getElementById('searchs').value='<?php echo $matches[3][$xh];?>'" title="<?php echo $matches[3][$xh];?>"><?php echo $matches[3][$xh];?></a></li>
					<?php
						$xh = $xh + 1;}?>
				</b>
			</ul>
	...
	<div class="stui-pannel_hd">
	<div class="stui-pannel__head active bottom-line clearfix">
	<h3 class="title">今日男明星排行榜</h3></div>
	</div>
	</div>
			<ul class="wprm">
				<b>
	...
	<div class="stui-pannel_hd">
	<div class="stui-pannel__head active bottom-line clearfix">
	<h3 class="title">今日欧美明星排行榜</h3></div>
	</div>
	</div>
			<ul class="wprm">
				<b>
