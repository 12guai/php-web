...
$surl = 'https://www.yy.com/shenqu/show/info.do?resid=' .$_GET['post']. '';
$url = fileget2($surl,5);
$lname ='#"songName":"(.*?)"#';
$aname ='#"anchorName":"(.*?)"#';
$cname ='#"watchCount":"(.*?)"#';
			...
			<div class="stui-pannel stui-pannel-bg clearfix">
				<div class="stui-pannel-box b playlist mb">
					...
					<div class="stui-pannel_bd col-pd clearfix dianshijua" id="dianshijuid">
						...
						<?php
						$url1 = 'https://www.yy.com/shenqu/play/id_' .$_GET['post']. '.html';
						$url2 = fileget2($url1,5);
			...
			<div class="stui-pannel stui-pannel-bg clearfix">
				<div class="stui-pannel-box">
					...
					<div class="stui-pannel_bd clearfix">
						...
						<?php
						$url0 = 'https://www.yy.com/shenqu/hot/daily.html';
						$url = fileget2($url0,5);
