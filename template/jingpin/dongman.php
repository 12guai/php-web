...
if ($i<1){echo 'active';}
echo '"><a class="stui-banner__pic" href="seacher-'.$listc['data'][$i]['link'].'.html" alt="'.$listc['data'][$i]['link'].'" style="background: url('.$listc['data'][$i]['cover'].') rgba(98,71,136,0) no-repeat; background-position: center center; background-size: cover; display: block; width: 100%; height: 100%;" title="'.$listc['data'][$i]['link'].'"><div class="am-slider-desc"><div class="am-slider-content"><h3 class="am-slider-title">'.$listc['data'][$i]['link'].' - '.$listc['data'][$i]['desc'].'</h3><p></p></div></div></a></div>';}?>
</div>
</div>
<style type="text/css">
...
<ul class="stui-vodlist clearfix">
				<?php
					for($i=0;$i<$pagecount;$i++){
						...
						echo "<span class='pic-tag pic-tag-b'>".$list['data'][$i]['tag']."</span></a><div class='stui-vodlist__detail active'><h4 class='title text-overflow'><a href='$ccb' title='".$list['data'][$i]['title']."'>".$list['data'][$i]['title']."</a></h4></div></div></li>";
						}?>
				</ul>
</div>
</div>
