...
<div class="mainBody">
	<div class="text">
		<p style="margin-top:40px">版权所有MKCMS开发团队保留所有权利。<br />
		...
		<p>
		<h4>I. 协议许可的权利</h4>
		您可以在完全遵守本最终用户授权协议的基础上，将本源码应用于非商业用途，您可以在协议规定的约束和限制范围内修改MKCMS源代码(如果被提供的话)或界面风格以适应您的网站要求。<br />
		您拥有使用本源码构建的网站中全部会员资料、文章及相关信息的所有权，并独立承担与文章内容的相关法律义务。
		</p>
		<p>
		<h4>II. 协议规定的约束和限制</h4>
		不得将本源码用于商业用途（包括但不限于企业网站、经营性网站、以营利为目或实现盈利的网站），不得贩卖或免费分享此程序，包括二次开发的程序。
		</p>
		<p>
		<h4>III. 有限担保和免责声明</h4>
