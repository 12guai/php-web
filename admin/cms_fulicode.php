...
$result = mysqli_query($conn,'select * from mkcms_diy where id = 1');
	...
	<?php echo'<textarea id="s_fulicode" class="form-control" name="s_fulicode" style="height:500px;" />'.htmlspecialchars($row['s_fulicode']).'</textarea>';
