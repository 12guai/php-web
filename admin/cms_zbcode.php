						...
						<div class="col-lg-12">
							<div class="panel bk-bg-white">
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-tags red"></i>直播代码自定义</h6>
								</div>
...
$result = mysqli_query($conn,'select * from mkcms_diy where id = 1');
	...
	<?php echo'<textarea id="s_zbcode" class="form-control" name="s_zbcode" style="height:400px;" />'.htmlspecialchars($row['s_zbcode']).'</textarea>';
